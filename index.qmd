...
A log() transformation was applied to the Selling_price, this produced much better models With the hold out method still preforming the best but not by much. all the models had about the same RMSE,R^2 and MAE. The Hold Out method has RMSE= 0.554, R^2 0.828 and MAE 0.401.  
...
\begin{align*}Selling\_Price =  -187.9796 -0000011Kms\_Driven 0.9575Fuel\_TypeDiesel \\ 
