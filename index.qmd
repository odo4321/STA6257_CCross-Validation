...
We preformed a normal liner regression using the carData set trying to predicted teh sells price using information about the car. 

$Selling_Price = Kms_Driven + Fuel_Type + Seller_Type + Transmission + Year$

We preformed the linear regression using 4 different types of cross validation. 
...
the model that was varavied using a traing set and valadation set preformed the best,
