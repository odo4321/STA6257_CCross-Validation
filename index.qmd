...
Plot below is a scatter plot of Year and Selling Price. The new cars seams to sell for more then older cars. 
...
plot(car_data$Year, car_data$Selling_Price,
     ...
     main = "Scatter Plot")
```
This is a Scatter Plot of kms Driven and Selling Price there does not seam to be a connection between the Kms driven and the selling price of the car. 
```{r, warning=FALSE, echo=T, message=FALSE}
